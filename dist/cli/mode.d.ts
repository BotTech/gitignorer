 ...
 */
export declare function resolveMode(opts: ModeOptions): CliMode;
/**
 * Type guard for INTERACTIVE mode.
 */
export declare function isInteractiveMode(mode: CliMode): boolean;
/**
 * Type guard for AGENT mode.
 */
export declare function isAgentMode(mode: CliMode): boolean;
