 ...
 */
export function parseOutputFlag(value) {
    if (value === 'json' || value === 'ndjson' || value === 'stdout') {
        return value;
    }
    throw new ValidationError(`Invalid output format: ${String(value)}. Must be json, ndjson, or stdout`, []);
}
/**
...
export function parseInputFlag(value) {
    ...
    throw new ValidationError(`Invalid input format: ${String(value)}. Must be json`, []);
}
